package net.fabricmc.splash.discord2.net.arikia.dev.drpc;
...
public final class DiscordRPC {
	 ...
	 *
	 * @see net.fabricmc.splash.discord2.net.arikia.dev.drpc.callbacks.JoinRequestCallback
	 */
	public enum DiscordReply {
		 ...
		 *
		 * @see net.fabricmc.splash.discord2.net.arikia.dev.drpc.callbacks.JoinGameCallback
		 */
		YES(1),
		/**
